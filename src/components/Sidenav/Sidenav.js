...
const Sidenav = () => {
    ...
    const difflocation = window.location.assign;
      ...
      <header>
          <div className="image-text">
              ...
              <div className="text logo-text">
                  <span className="name">SchoolHub</span>
                  <span className="profession">By:<br></br> Isaiah Dickerson <br></br>  Cole Goodman <br></br> & Tochi Onwuasoanya</span>
              </div>
          </div>
      ...
      <div className="menu-bar">
       ...
       <nav>
              ...
              <ul className="menu-links">
                  <li className={`nav-link ${location === '/notes'?"active":""}`}>
                        ...
                        <Link to={'/myaccount'}>
                          ...
                          <li className="nav-link">
                            <a href= "https://calendar-67poixb5p-tochi-onwuasoanya.vercel.app">
                  ...
                  <li className="nav-link">
                            <a href= "https://chrome-riu25mx4x-tochi-onwuasoanya.vercel.app/">
                          <i className="fa-solid fa-calculator icon"></i>
                          <span className="text nav-text">Calculator</span>
                          </a>
                  </li>
